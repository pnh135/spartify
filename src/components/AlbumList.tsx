...
export default function AlbumList({
  ...
  return (
    <section className="ml-8">
      <h2 className="my-16 text-white text-2xl font-bold mb-5">
        {albumListName}
      </h2>
            ...
            <Link key={album.title} href={`/detail/${album.title}`}>
              <article className="text-white hover:bg-zinc-800 p-3 rounded-md group">
                <figure className="w-[180px] h-[180px] overflow-hidden mb-2 rounded-md relative">
                  ...
                  />
                  <span className="absolute bottom-2 right-2 opacity-0 group-hover:opacity-100 duration-200 transition-transform group-hover:-translate-y-2">
